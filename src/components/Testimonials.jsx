...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'SafiSpace transformed my 2-bedroom apartment. Faith was incredibly thorough — every corner spotless. The team arrived on time and left the place smelling amazing!',
    initials: 'AM',
    color: '#001B5E',
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    text: 'Used SafiSpace for a move-out clean and got my full deposit back! Booking was effortless, the team arrived on time, and the results were flawless. Will always use them.',
    initials: 'LO',
    color: '#0048c8',
  },
];
